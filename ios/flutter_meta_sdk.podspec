...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
  More information about Meta SDK for iOS you can reference the official documentation https://developers.facebook.com/docs/ios
                       DESC
  ...
  s.dependency 'FacebookCore', '~> 18.0.3'
  s.platform = :ios, '13.0'
  ...
  # s.resource_bundles = {'flutter_meta_sdk' => ['Resources/PrivacyInfo.xcprivacy']}
end
